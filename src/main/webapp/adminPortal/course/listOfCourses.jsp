										...
										<tbody>
											...
											<c:forEach items="${course}" var="c">
												<tr>
													...
													<td><c:out value="${c.department.departmentName}" /></td>
													<td>
													<button id="lessonlist" type="submit" onclick="submitRequest(${c.courseId},'lessonList');">list of Lesson's</button>
											         </td>
											         <td>
