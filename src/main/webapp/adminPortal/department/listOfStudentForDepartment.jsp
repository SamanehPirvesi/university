...
List<Student> students = (List<Student>) departmentService.getListOfStudentForDepartment(id);
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Students list of Department </h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">Students list Of Department (  ${departmentName} )</div>
							<!-- /.panel-heading -->
